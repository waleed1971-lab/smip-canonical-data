...
التحديث الآلي **مفعل** عبر GitHub Actions بعد نجاح اختبار Repository-side integrity gate من بيئة المتابعة. يعمل بخمس محاولات احتياطية في أيام التداول السعودية، الساعة 16:05 و16:25 و16:45 و17:05 و17:25 بتوقيت الرياض، وحد freshness التشغيلي الساعة 17:45. يسحب فقط مساري البحث العامين للقراءة من `smip-server.onrender.com` ولا يحتاج Token أو سرًا جديدًا. تعدد المحاولات يعالج تأخر أو سقوط تشغيل cron لدى GitHub؛ وبسبب idempotency لا ينشئ أي commit إضافي إذا لم توجد جلسة أحدث.
