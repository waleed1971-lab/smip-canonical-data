...
التحديث الآلي **مفعل** عبر GitHub Actions بعد نجاح اختبار Repository-side integrity gate من بيئة المتابعة. يعمل بخمس محاولات احتياطية في أيام التداول السعودية، الساعة 18:45 و19:05 و19:25 و19:45 و20:05 بتوقيت الرياض. يسحب فقط مساري البحث العامين للقراءة من `smip-server.onrender.com` ولا يحتاج Token أو سرًا جديدًا. تعدد المحاولات يعالج تأخر أو سقوط تشغيل cron لدى GitHub؛ وبسبب idempotency لا ينشئ أي commit إضافي إذا لم توجد جلسة أحدث.
